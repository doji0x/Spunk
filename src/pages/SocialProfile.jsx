...
export default function SocialProfile() {
  const { wallet } = useParams(); const { address, provider } = usePhantomWallet(); const [profile, setProfile] = useState(null); const [posts, setPosts] = useState([]); const [loading, setLoading] = useState(true); const [editing, setEditing] = useState(false); const [composing, setComposing] = useState(false);
