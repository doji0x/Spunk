  ...
  return <div className="validate-surface min-h-screen text-foreground">
    ...
    <main className="mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-3xl flex-col px-4 sm:px-6">
      <div className="flex items-start gap-3 py-7">
        ...
        <div><h2 className="font-display text-2xl font-bold tracking-tight">Astra</h2><p className="mt-1.5 text-sm leading-6 text-muted-foreground">Acts as foreman over a crew — architect, logic, functions, integration, documentation and audit engineers — assigning each a scoped job and reporting back. All work lands on a separate <span className="font-mono text-primary">astra/*</span> test branch you can review and merge.</p></div>
      </div>
