...
export default function ValidationResult({ result }) {
  ...
  const boundCheck = result.checks?.bound || { status: 'unknown', message: 'This check was not returned.' };
  return <section aria-live="polite" className="mt-5 overflow-hidden rounded-2xl border border-[#dce1d5] bg-white text-left">
    ...
    <StandardCheck title="Token-2022 Bound Inscription" check={boundCheck} kind="bound" />
