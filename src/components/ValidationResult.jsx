...
export default function ValidationResult({ result }) {
  ...
  return <section aria-live="polite" className="mt-5 overflow-hidden rounded-3xl border border-border bg-card text-left">
    ...
    <p className="border-t border-border p-5 text-[10px] leading-relaxed text-muted-foreground">Verifies on-chain media bytes at lookup time, not ownership, originality, token value, or safety.</p>
  </section>;
}