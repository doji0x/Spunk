...
export default function PunksHero() {
  return <section className="pb-16 text-center sm:pb-20">
    ...
    <p className="mx-auto mt-7 max-w-xl text-sm leading-7 text-muted-foreground sm:text-base">Punks is where Solana’s curation culture becomes permanent—a canon assembled for collectors who understand that provenance is part of the work, not an afterthought. Every selected Cypher Punk is preserved in full on-chain, with its complete image bytes anchored to Solana. No mutable media. No substituted files. No trust required. What enters the canon remains exactly what was collected.</p>
  </section>;
}