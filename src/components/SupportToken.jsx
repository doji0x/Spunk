...
export default function SupportToken() {
  ...
  return <button type="button" onClick={copyAddress} title={address} className="flex basis-full flex-col items-center gap-1 border-t border-border pt-4 text-center transition hover:text-primary">
    <span className="font-medium text-primary">Support token · Creator fees support this work</span>
