...
export default function LaunchLinksFields({ links, onChange, disabled, className = 'grid gap-3 sm:grid-cols-3' }) {
  return <div className={className}>{fields.map(([key, label, placeholder]) => <div key={key} className="space-y-1.5">
